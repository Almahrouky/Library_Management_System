...
- A user can query for a book/staff and add or remove book/staff.
#### Entities
For this database I've choose the following entities and their attributes:
##### 1- users
...
For this database I used types:
...
- indexing: for username, password, staff name, books name and author name to speed up these query.
## Technologies Used
